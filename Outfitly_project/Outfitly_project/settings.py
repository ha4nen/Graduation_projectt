"""
Django settings for Outfitly_project project.
...
SECRET_KEY = 'django-insecure-8cftl3nn=uf$^fjc@ch9h&l15vj_-9$%&+r35(rah_q9*$1gsl'
...
WSGI_APPLICATION = 'Outfitly_project.wsgi.application'
